...
let popupCloseMestoButton = document.querySelector('.popup__close-mesto')
...
let popupMesto = document.querySelector('.popup__mesto')
...
let popupFormMesto = document.querySelector('.popup__form-mesto')
let popupSaveMesto = document.querySelector('.popup__save-mesto')
let openImage = document.querySelector('.popup__open-image')
let closeImage = document.querySelector('.popup__close-image')
let image = document.querySelector('.popup__image')
let imageSign = document.querySelector('.popup__image-sign')
